message = """ytn xqavhq yzhu  xu qzupvd ltmat qnncq vgxzy hmrty vbynh ytmq ixur qyhvurn
...
alphabet = 'ETAONSIRHLDCMUWBFGPYVKQXZJ'
...
def frequency(message):
	...
	lst = sorted(letterCount.items(), key = lambda x:x[1])
	lst.reverse()
	print(lst, end = "\n\n")
	for i in range(len(lst)):
		print(lst[i][0], "=>", alphabet[i])
		result += lst[i][0]
	return result
